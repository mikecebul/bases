...
export function ClickableCard({ buttonText, buttonDescription }: ClickableCardProps) {
  return (
    <div className="max-w-md p-8 mx-auto transition-all duration-200 border-2 border-blue-100 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl has-[button:hover]:border-blue-200 has-[button:hover]:shadow-lg">
      ...
      <SimplePracticeContact buttonText={buttonText} className="w-full" card={false} variant="brand" />
