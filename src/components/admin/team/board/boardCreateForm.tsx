...
import { CreateBoardMemberAction } from "@/actions/board/create-board-member-action";
import { generateSlug, revalidate } from "@/lib/utils";
import FirstTeamProfilePicture from "../firstTeamProfilePicture";
...
export default function BoardCreateForm() {
  ...
  return (
    <div className="p-8 max-w-7xl">
      <FirstTeamProfilePicture imageUrl={imageUrl} setImageUrl={setImageUrl} />
      <Form {...form}>
