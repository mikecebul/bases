...
//     >
//       <div className="w-full py-24 2xl:container lg:pb-32 lg:px-0">
//         <CardHeader className="px-4 pt-0 2xl:container md:px-8 2xl:px-0">
...
//         </CardHeader>
//         <CardContent className="grid px-4 sm:grid-cols-2 sm:gap-16 md:px-8 2xl:px-0">
//           <div>
