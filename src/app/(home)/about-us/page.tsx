        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-16 xl:container xl:grid-cols-2 xl:items-start xl:gap-y-10 xl:gap-x-10 xl:px-0">
          <div className="xl:col-start-1 xl:row-start-1 xl:grid xl:w-full xl:gap-x-8 xl:px-0">
            ...
            <p className="mt-6 text-base font-normal leading-7 max-w-prose">
              ...
              and Celia Kelly in 1993, originally began as a home-based
              operation addressing adolescent substance abuse. As we expanded to
              meet the needs of our community, we formed the Teen Center in
              1995, providing a safe after-school space to tackle the rising
              concern of substance abuse among young people.
            </p>
          </div>
          ...
          <div className="xl:pr-4">
            <div className="text-base leading-7 max-w-prose">
              <p>
                ...
                primary focus was adolescent treatment until 2015, we also
                offered services for adults and provided resources in local
                schools, jails, and through community outreach.
              </p>
              <p className="mt-6">
                In 2015, after the Recovery High program ended, we transitioned
                our focus to adults. Recognizing the intricate connection
                between substance abuse, mental health, and trauma, we expanded
                our expertise to address these co-occurring issues.
              </p>
              <p className="mt-6">
                When the COVID pandemic hit, we adapted swiftly, initiating
                telehealth services that allowed us to expand our reach across
                Michigan and break down accessibility barriers to treatment.
                This commitment to evolving with the times and meeting changing
                needs is what led us to create our new domain, BASESmi.org.
              </p>
              ...
              <div className="text-base leading-7 max-w-prose">
                <p className="mt-6 text-base leading-7">
                  BASES has always been personal and family-oriented for Scott
                  and Celia. Collectively, they have over 74 years of sobriety.
                  They are living proof that recovery can have a meaningful and
                  lasting impact on a family system. Everyone always talks about
                  addiction and mental health being prevalent in their family
                  tree, but the Kelly&apos;s strive to also teach that recovery
                  can run in families, too.
                </p>
                <p className="mt-6">
                  As Scott and Celia plan to consider retirement of some sort in
                  the next 8 years, they plan to pass the torch to their
                  daughter, Leah, who has worked for BASES for many years and
                  been along for the ride since the beginning. During the next
                  few years, Leah will take on more director duties. BASES will
                  continue to strive to meet the needs of the community and
                  provide quality services that people have come to know and
                  expect.
                </p>
                <p className="mt-6">
