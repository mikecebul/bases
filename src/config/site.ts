    ...
    staff: [
      {
        ...
        bio: [
          ...
          "Scott was elected to the Ferris State University Athletic Hall of Fame in September of 2007; Click the Icon below to view the FSU information; the Manistee Saints Semi-Pro Baseball Hall of Fame in 2009 and the Michigan Amateur Softball Association Hall of Fame in January of 2015.",
        ],
      },
      {
        ...
        id: "2",
        bio: [
          "Co-founder of BASES, began her career in the substance abuse field doing prevention programs with Head Start in 1988. She then accepted a position as a Prevention Specialist with Chip Counseling Center and later became the Prevention Coordinator for Antrim, Charlevoix, Cheboygan and Emmet counties.",
